function ContractorsIcon() {
  return (
    <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M9.5 22L12.3868 17H6.61325L9.5 22ZM10 17.5L10 12H9L9 17.5H10Z" fill="#94E60F"/>
      <path
        ...
        fill="#94E60F"/>
      <path d="M20 31.5L25 34.3868V28.6132L20 31.5ZM24.5 32H30V31H24.5V32Z" fill="#94E60F"/>
    </svg>
  );
}
